    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row shrink-0 justify-center items-center gap-2">
        ...
        <Container className="circle-3">
          <MistralLogo className="h-8 w-8 dark:text-white" />
        </Container>
...
export const MistralLogo = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M4 19V5H8V19H4Z" fill="currentColor" />
      <path d="M10 5V19H14V5H10Z" fill="currentColor" />
      <path d="M16 19V5H20V19H16Z" fill="currentColor" />
    </svg>
  );
};
