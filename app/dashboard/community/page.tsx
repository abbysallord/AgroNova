...
export default function CommunityPage() {
    ...
    const fetchUsers = async () => {
        ...
        try { const res = await fetch("/api/users", { cache: "no-store" }); setUsers(await res.json()); }
        catch (e) { }
                        ...
                        {activeTab === "network" && (
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {loadingUsers ? (
                                        [1, 2, 3, 4, 5, 6].map(i => (
                                            <div key={i} className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-xl p-6 flex flex-col items-center gap-4 animate-pulse">
                                                <div className="w-16 h-16 rounded-full bg-gray-200 dark:bg-neutral-800" />
                                                ...
                                                <div className="flex gap-2 w-full mt-2">
                                                    <div className="flex-1 h-8 bg-gray-200 dark:bg-neutral-800 rounded-lg" />
                                                    <div className="w-10 h-8 bg-gray-200 dark:bg-neutral-800 rounded-lg" />
                                                </div>
                                            </div>
                                        ))
                                    ) : (
