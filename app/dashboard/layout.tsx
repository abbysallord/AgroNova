...
export const metadata: Metadata = {
  title: "Dashboard | AgroNova Smart Farming",
  description: "Manage your farm, view real-time market prices, check weather forecasts, and analyze crop health from your personalized dashboard.",
};
